...
public class BooksRepo {
    ...
    public List<Books> sortBookByPriceAsc(){
        String query="select * from books order by book_cost";
    ...
    public List<Books> sortBookByPriceDesc(){
        String query="select * from books order by book_cost desc";
